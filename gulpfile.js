...
//gulp.task("minifyHTML", function() {
    gulp.src(["src/index.html", "src/gallery.html", "src/sounds.html",
  "src/tour.html", "src/videos.html"])
        .pipe(minifyHTML())
        .pipe(gulp.dest('dist'));
        //.pipe(connect.reload());
});
...
gulp.task("build", ['minifyScripts', 'compileSass', 'minifyCSS', 'minifyHTML', 'images','image'], function() {
